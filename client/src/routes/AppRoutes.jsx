...
const AppRoutes = () => {
  return (
    <Routes>
      ...
      <Route path="/community/write" element={<PrivateRoute><PostWritePage /></PrivateRoute>} />

      {/* Pets */}
      <Route path="/pets" element={<PrivateRoute><MyPetsPage /></PrivateRoute>} />
      <Route path="/pets/add" element={<PrivateRoute><AddPetPage /></PrivateRoute>} />
      <Route path="/pets/edit/:id" element={<PrivateRoute><EditPetPage /></PrivateRoute>} />

      {/* Calendar */}
      <Route path="/calendar" element={<PrivateRoute><CalendarPage /></PrivateRoute>} />
      <Route path="/calendar/add" element={<PrivateRoute><AddEventPage /></PrivateRoute>} />

      {/* Health */}
      <Route path="/health/consult" element={<PrivateRoute><AiConsultPage /></PrivateRoute>} />
      <Route path="/health/result" element={<PrivateRoute><AiResultPage /></PrivateRoute>} />
